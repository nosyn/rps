...
export async function storeAndParseFile(filename: string, fileBuffer: Buffer, mimeType: string) {
...
async function saveDocument(filename: string, fileBuffer: Buffer, mimeType: string) {
